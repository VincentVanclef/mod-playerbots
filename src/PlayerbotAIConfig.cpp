...
bool PlayerbotAIConfig::Initialize()
{
    ...
    rtgBgObjectiveBrain = sConfigMgr->GetOption<bool>("AiPlayerbot.RTG.BG.ObjectiveBrain", true);
    rtgBgDebugObjectiveBrain = sConfigMgr->GetOption<bool>("AiPlayerbot.RTG.BG.DebugObjectiveBrain", false);
