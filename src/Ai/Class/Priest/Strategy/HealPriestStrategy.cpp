...
{
    return {
        NextAction("power word: shield on not full", ACTION_DEFAULT + 12.0f),
        NextAction("power word: shield on almost full health below", ACTION_DEFAULT + 11.0f),
...
void HealPriestStrategy::InitTriggers(std::vector<TriggerNode*>& triggers)
{
    ...
    triggers.push_back(
        new TriggerNode(
            "group heal setting",
            {
                ...
                NextAction("power word: shield on not full", ACTION_MEDIUM_HEAL + 18),
                NextAction("power word: shield on almost full health below", ACTION_MEDIUM_HEAL + 17),
    ...
    triggers.push_back(
        new TriggerNode(
            "medium group heal setting",
            {
                ...
                NextAction("power word: shield on not full", ACTION_CRITICAL_HEAL + 16),
                NextAction("power word: shield on almost full health below", ACTION_CRITICAL_HEAL + 14),
    ...
    triggers.push_back(
        new TriggerNode(
            ...
            {
                NextAction("power word: shield on not full", ACTION_CRITICAL_HEAL + 20),
                NextAction("power word: shield on party", ACTION_CRITICAL_HEAL + 15),
    ...
    triggers.push_back(
        new TriggerNode(
            ...
            {
                NextAction("power word: shield on not full", ACTION_MEDIUM_HEAL + 14),
                NextAction("power word: shield on party", ACTION_MEDIUM_HEAL + 12),
    ...
    triggers.push_back(
        new TriggerNode(
            ...
            {
                NextAction("power word: shield on not full", ACTION_LIGHT_HEAL + 18),
                NextAction("power word: shield on party", ACTION_LIGHT_HEAL + 16),
    ...
    triggers.push_back(
        new TriggerNode(
            ...
            {
                NextAction("power word: shield on almost full health below", ACTION_LIGHT_HEAL + 14),
