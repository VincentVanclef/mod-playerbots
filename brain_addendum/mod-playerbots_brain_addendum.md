...
Module Version: 2.3.8y
RTG Brain Compatibility Version: 5.4.0
Commit Title: Honor RDF helper roles and prioritize planner-driven BG refill
Commit Description: Fixes RTG RDF helper realization by honoring desired RDF roles during queued-helper login and preserving RDF helper capacity instead of donating unused LFG slots to BG. Also prioritizes battleground live_refill and finish_fill buckets ahead of startup queues so overlapping battlegrounds stop starving refill demand.
